// app/api/polls/[id]/comments/route.ts - Handle poll comments
  ...
  try {
    ...
    try {
      ...
      const insertCommentQuery = `
        INSERT INTO poll_comments (poll_id, user_id, content, created_at)
...
export async function GET(
  ...
  try {
    ...
    try {
      ...
      const result = await client.query(commentsQuery, [pollId]);
